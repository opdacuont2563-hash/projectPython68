...
DEPT_DOCTORS = {
    ...
    "Ophthalmology | จักษุ": ["นพ.สราวุธ สารีย์", "พญ.ดวิษา อังศรีประเสริฐ", "พญ.สาวิตรี ถนอมวงศ์ไทย",
                              "พญ.สีชมพู ตั้งสัตยาธิษฐาน", "พญ.นันท์นภัส ชีวะเกรียงไกร"],
...
DOCTOR_ALIASES: Dict[str, str] = {
    ...
    "พญ.สีกชมพู ตั้งสัตยาธ": "พญ.สีชมพู ตั้งสัตยาธิษฐาน",
    "พญ.สีกชมพู ตั้งสัตยาธิษฐาน": "พญ.สีชมพู ตั้งสัตยาธิษฐาน",
    "พญ.สี ชมพู ตั้งสัตยาธิษฐาน": "พญ.สีชมพู ตั้งสัตยาธิษฐาน",
}
...
class Main(QtWidgets.QWidget):
    ...
    def _build_ui(self):
        ...
        self.btn_clear_board.setProperty("variant", "danger")
    ...
    def _on_import_excel(self):
        path, _ = QtWidgets.QFileDialog.getOpenFileName(
            ...
            str(Path.home()),
            "Excel/CSV (*.xlsx *.xlsm *.xltx *.xltm *.csv)"
        )
        if not path:
            return
